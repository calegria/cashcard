...
class CashcardApplicationTests {
  ...
  void shouldReturnACashCardWhenDataIsSaved() {
    ...
    ResponseEntity<String> response =
        restTemplate.withBasicAuth("sarah1", "abc123").getForEntity("/cashcards/99", String.class);
  ...
  void shouldReturnASortedPageOfCashCardsWithNoParametersAndUseDefaultValues() {
    ResponseEntity<String> response =
        restTemplate.withBasicAuth("sarah1", "abc123").getForEntity("/cashcards", String.class);
    assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
  ...
  /**
   * <p>
   * <b>Autenticacion </b> Caso: credenciales invalidas
   * </p>
   * 
  ...
  void shouldNotReturnACashCardWhenUsingBadCredentials() {
    ...
    response = restTemplate.withBasicAuth("sarah1", "BAD-PASSWORD").getForEntity("/cashcards/99",
        String.class);
    assertThat(response.getStatusCode()).isEqualTo(HttpStatus.UNAUTHORIZED);
  }
  ...
  /**
   * <p>
   * <b>Autorización </b> Caso: credenciales invalidas
   * </p>
   * 
   * @author <a href="alineumsoft@gmail.com">C. Alegria</a>
   */
  ...
  /**
   * <p>
   * <b>Autorización </b> Caso: segregación por usuario dueño de recurso
   * </p>
   * 
   * @author <a href="alineumsoft@gmail.com">C. Alegria</a>
   */
  ...
  void shouldNotAllowAccessToCashCardsTheyDoNotOwn() {
    ResponseEntity<String> response =
        restTemplate.withBasicAuth("sarah1", "abc123").getForEntity("/cashcards/102", String.class); // kumar2's
                                                                                                     // data
    assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
  }
  ...
  /**
   * <p>
   * <b>PUT </b> actualizacion de todo el objecto
   * </p>
   * 
   * @author <a href="alineumsoft@gmail.com">C. Alegria</a>
   */
  ...
  void shouldNotAllowDeletionOfCashCardsTheyDoNotOwn() {
    ...
    ResponseEntity<String> getResponse =
        restTemplate.withBasicAuth("kumar2", "xyz789").getForEntity("/cashcards/102", String.class);
    assertThat(getResponse.getStatusCode()).isEqualTo(HttpStatus.OK);
  }
}
